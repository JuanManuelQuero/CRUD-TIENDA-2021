        ...
        <form action="<?php echo $_SERVER['PHP_SELF']."?id=$id"; ?>" name="a" method="POST">
            <div class="bg-info p-4 text-white rounded shadow-lg m-auto" style="width: 40rem;">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="n" value="<?php echo $datosCategoria->nombre; ?>" name="nombre" required>
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="d" name="descripcion" value="<?php echo $datosCategoria->descripcion; ?>">
                    <?php
